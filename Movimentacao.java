...
public class Movimentacao {
    ...
    public String toString() {
        return String.format("Movimentacao[id=%d, carteira=%d, data=%s, tipo=%s, qtd=%s, cotacao=%s]", idMovimento, idCarteira, dataOperacao, tipoMovimentacao, quantidade, cotacaoNaData);
    }
}
